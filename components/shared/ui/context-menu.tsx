      ...
      <ContextMenuPrimitive.Positioner
        ...
        <ContextMenuPrimitive.Popup
          ...
          className={cn(
            ...
            outline-none data-[side=bottom]:slide-in-from-top-2 data-[side=inline-end]:slide-in-from-left-2
  ...
  return (
    <ContextMenuPrimitive.SubmenuTrigger
      ...
      className={cn(
        ...
        focus:bg-accent focus:text-accent-foreground data-inset:pl-7 data-open:bg-accent
  ...
  return (
    <ContextMenuPrimitive.CheckboxItem
      ...
      className={cn(
        ...
        select-none focus:bg-accent focus:text-accent-foreground data-inset:pl-7 data-disabled:pointer-events-none
...
function ContextMenuItemWitchIcon({
  IconType,
  shortCut,
  children,
  ...props
  ...
  return (
    <ContextMenuItem {...props}>
      <IconType className="size-4 shrink-0" aria-hidden="true" />
