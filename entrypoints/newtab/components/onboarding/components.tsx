...
export const StepNavigationButtons: FC<StepNavigationButtonsProps> = ({
  ...
  <Stack className="gap-2 w-full">
    {onBack && (
      <Button variant="outline" onClick={onBack} className="flex-1" data-testid="onboarding-back">
        {backLabel ?? t('onboardingBack')}
      </Button>
    )}
    {onSkip && (
      <Button variant="outline" onClick={onSkip} className="flex-1" data-testid="onboarding-skip-step">
        {skipLabel ?? t('onboardingSkip')}
      </Button>
    )}
    <Button onClick={onNext} className="flex-1" disabled={nextDisabled} data-testid="onboarding-next">
