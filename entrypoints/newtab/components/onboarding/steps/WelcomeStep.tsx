  ...
  return (
    <StepContainer>
      ...
      <Stack direction="column" className="gap-3 w-full">
        ...
        <Button onClick={onNext} className="w-full" data-testid="onboarding-start">
          {t('onboardingStartSetup')}
        </Button>
        <Button variant="ghost" onClick={onSkipAll} className="w-full" data-testid="onboarding-skip-all">
          {t('onboardingSkipAll')}
        </Button>
      </Stack>
    </StepContainer>
