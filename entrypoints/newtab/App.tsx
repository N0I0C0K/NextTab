import './App.css'
import { Center, Text, Heading, Stack } from '@/components/shared'
...
import { settingStorage, DEFAULT_WALLPAPER_URL, localWallpaperStorage } from '@/utils/storage'
    ...
    <>
      <div
        ...
        {settings.useHistorySuggestion ? (
          <Suspense fallback={<div style={{ flexGrow: 0.7 }} />}>
